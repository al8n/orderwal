...
impl<'a, C> MultipleVersionMemtableEntry<'a> for Entry<'a, MemtableComparator<C>>
where
  C: Comparator,
{
  #[inline]
...
impl<'a, C> MultipleVersionMemtableEntry<'a> for VersionedEntry<'a, MemtableComparator<C>>
where
  C: Comparator,
{
  #[inline]

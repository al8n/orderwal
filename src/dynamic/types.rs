...
mod sealed {
  ...
  // impl Sealed<'_> for super::Active {}

  // impl Sealed<'_> for super::MaybeActive {}

  impl<'a, T: skl::State<'a>> Sealed<'a> for T {}
}

// /// Value that can be converted from a byte slice.
// pub trait Value<'a>: sealed::Sealed<'a, <Self as Value<'a>>::Ref> + Clone {
//   /// The reference type.
//   type Ref;
// }

// // impl<'a, V: skl::generic::GenericValue<'a> + Clone> Value<'a> for V {
// //   type Ref = V::Ref;
// // }

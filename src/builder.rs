// use super::{
//   checksum::BuildChecksumer, options::ArenaOptionsExt, sealed::Constructable, wal::Wal, *,
// };
...
//       .and_then(|arena| <W as Constructable<C, S>>::new_in(arena, opts, cmp, cks).map(W::from_core))
//   }
...
//       .and_then(|arena| {
//         <W::Reader as Constructable<C, S>>::replay(arena, Options::new(), true, cmp, cks)
//           .map(<W::Reader as Constructable<C, S>>::from_core)
...
//       .and_then(|arena| {
//         if !exist {
//           <W as Constructable<C, S>>::new_in(arena, opts, cmp, cks).map(W::from_core)
//         } else {
//           <W as Constructable<C, S>>::replay(arena, opts, false, cmp, cks).map(W::from_core)
//         }
//       })
//       .map_err(Either::Right)
//   }
